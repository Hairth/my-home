export default function HelloWorld() {
  return (
    <article className="prose mx-auto max-w-3xl px-6 py-16 dark:prose-invert">
      <a className="text-sm no-underline text-stone-500 hover:text-stone-700" href="/writings">
        ← 全部文章
      </a>
      <h1>你好，星火</h1>
